...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classShardPref = new SharedP (MainActivity.this.getApplicationContext());
    ...
    public void cekJawaban(View view) {
        ...
        if (cekIfKosong.isEmpty()) {
            hasilJawab.setText("Mohon Isi Dengan Benar");
            ...
            if (getJawab.equals(String.valueOf(hasil))) {
                ...
                Toast.makeText(this, "Selamat Jawaban Anda Benar", Toast.LENGTH_LONG).show();
                ...
                hasilJawab.setText("Jawaban : " + String.valueOf(hasil) + "\nJawaban Salah");
                Toast.makeText(this, "Maaf Jawaban Anda Kurang Tepat", Toast.LENGTH_LONG).show();
